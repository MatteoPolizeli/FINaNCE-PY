...
def home(request): #a function home, recebe uma request da url, e retorna uma response http:
...
def gerenciar(request):
  ...
  return render(request, 'gerenciar.html', {'contas': contas, 'total_contas': total_contas, 'categorias': categorias}) #esse dicinario é o tal do context, tenho que adicionar nesse render pra aparecer na tela
...
def dashboard(request):
  ...
  for categoria in categorias:
    ...
    for v in valores:
      total = total + v.valor
    dados[categoria.descricao] = total
