...
def novo_valor(request):
    if request.method == "GET":
      ...
      return redirect('/extrato/novo_valor') #REDIRECT == GET
...
def exportar_pdf(request):
  ...
  path_output = BytesIO()
  HTML(string=template_render).write_pdf(path_output) #Weasyprint utilizando o write_pdf

  path_output.seek(0) # voltando o ponteiro pro inicio do arquivo
